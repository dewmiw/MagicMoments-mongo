@extends('layouts.app')
@section('content')
<h1 class="text-2xl font-semibold mb-4">Edit Decoration Package</h1>
<form method="POST" action="{{ route('decorations.update', $item->_id) }}" class="bg-white rounded-2xl shadow p-6 space-y-4">
@csrf @method('PUT')
<div>
